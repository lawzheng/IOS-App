...
//    self.backgroundColor = [UIColor redColor];
    _avatorImageView.image = [UIImage imageNamed:@"icon.bundle/rest.png"];
    _nickLabel.text = @"即可";
    _commentImageView.image = [UIImage imageNamed:@"icon.bundle/skin.png"];
    _commentLabel.text = @"评论";
    _likeImageView.image = [UIImage imageNamed:@"icon.bundle/trophy.png"];
    _likeLabel.text = @"25";
    _shareImageView.image = [UIImage imageNamed:@"icon.bundle/USB.png"];
    _shareLabel.text = @"分享";
